        ...
        <?php if (function_exists('wam_adresse_visible') && wam_adresse_visible()): ?>
            <div class="page-cours__address wam-adresse-globale">
                ...
                <div class="page-cours__address-info">
                    ...
                    <span
                        class="page-cours__address-street text-sm"><?php echo nl2br(esc_html(wam_adresse_lieu())); ?></span>
                </div>
            </div>
        <?php endif; ?>

        <?php if ($show_planning && $planning_url): ?>
            <a href="<?php echo esc_url($planning_url); ?>" class="btn-secondary page-cours__planning-btn"
