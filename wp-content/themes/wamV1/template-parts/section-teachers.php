...
<section id="section-teachers" class="section-teachers relative flex flex-col items-center gap-12 py-18 w-full overflow-hidden"
    ...
    <div id="teachers-grid"
            ...
            <?php foreach ($teachers as $teacher):
                ...
                <a href="<?php echo esc_url($teacher_url); ?>"
                    ...
                    <div class="w-full h-[160px] rounded-wam-md overflow-hidden bg-wam-bg500">
                        <?php echo get_avatar($teacher->ID, 160, '', esc_attr($display_name), array(
                            'class'   => 'teacher-card__avatar w-full h-full object-cover block',
                            'loading' => 'lazy',
                        )); ?>
                    </div>
                    ...
                    <div class="flex flex-col items-center gap-3 w-full text-center">
                        ...
                        <?php endif; ?>
                        <span class="teacher-card__arrow flex items-center justify-center w-7 h-7 rounded-wam-sm transition-colors duration-200"
                            aria-hidden="true">
        ...
        <?php else: ?>
            ...
            <?php for ($i = 0; $i < 4; $i++): ?>
                <div class="teacher-card--placeholder flex flex-col items-center gap-8 p-4 bg-wam-bg600 rounded-wam-lg w-[240px]">
